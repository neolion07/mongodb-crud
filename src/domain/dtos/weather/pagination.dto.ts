export class WeatherPaginationDto{
    ...
    static create( object: {[key:string]:any} ): [string?, WeatherPaginationDto?]{
        ...
        return [undefined, new WeatherPaginationDto(+offset, +limit)];
    }
}